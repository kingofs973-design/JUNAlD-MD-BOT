...
const MENU_SOUND_PATH = path.join(__dirname, '../assets/pal-pal.ogg');
/*****************************************************************************
 *                                                                           *
 *                     Developed By JUNAID↣³⁰²                     *
 *                     & JUNAID↣³⁰²                                        *
...
const MENU_IMAGE_URL = 'https://i.ibb.co/QFQk0DGy/jawadmd.jpg';
...
const menuCommand = {
    ...
    async handler(sock, message, args, context) {
        ...
        if (fs.existsSync(MENU_SOUND_PATH)) {
            await sock.sendMessage(chatId, { audio: fs.readFileSync(MENU_SOUND_PATH), mimetype: 'audio/ogg; codecs=opus', fileName: 'Pal Pal.ogg', ptt: true, ...channelInfo }, { quoted: message });
        }
            } else {
